...
/**
 * This is the model class for table "LINEASPRESUPUESTOS".
 *
 * The followings are the available columns in table 'LINEASPRESUPUESTOS':
 * @property integer $id
 ...
 * @property PRESUPUESTOS $idFactura0
 */
class LINEASPRESUPUESTOS extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'idFactura0' => array(self::BELONGS_TO, 'PRESUPUESTOS', 'idFactura'),
		);
	}
	 ...
	 * @return LINEASPRESUPUESTOS the static model class
	 */
