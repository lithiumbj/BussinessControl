...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/custom.css" media="print" />
	<!--[if lt IE 8]>
...
<body>
	...
	<div id="header">
		<div id="logo">
                    ...
                    <span class="logoTitle"><?php //echo CHtml::encode(Yii::app()->name); ?></span>
                </div>
	</div><!-- header -->
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Clientes', 'url'=>'?r=CLIENTES'),
				array('label'=>'Empleados', 'url'=>'?r=EMPLEADOS'),
				array('label'=>'Facturas', 'url'=>'?r=FACTURAS'),
